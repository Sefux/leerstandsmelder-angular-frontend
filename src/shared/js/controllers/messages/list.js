...
var MessagesListController = function ($scope, $q, $location, apiService, responseHandler) {
...
MessagesListController.$inject = ['$scope', '$q', '$location', 'apiService', 'responseHandler'];
