...
var LsmDataCardListDirective = function ($q, apiService, assetPath, $translate) {
    return {
        restrict: 'A',
        templateUrl: assetPath + 'partials/_data_card_list.html',
        link: function (scope) {
...
LsmDataCardListDirective.$inject = ['$q', 'apiService', 'assetPath', '$translate'];

module.exports = LsmDataCardListDirective;